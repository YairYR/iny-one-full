  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
      ...
      <form className="flex flex-col" onSubmit={onSubmit}>
        ...
        <button type="submit"
                className="w-full text-[#FFFFFF] bg-[#4F46E5] focus:ring-4 focus:outline-hidden focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6 cursor-pointer">Login
        </button>
        <div className="text-sm font-light text-[#6B7280] ">Don&#39;t have an account yet? <a href="#"
